"""
Script de hien thi ket qua training da luu
Chay trong Colab cell rieng sau khi training xong
"""
...
def display_training_results():
    ...
    image_path = 'module_bai_2/training_history.png'
    json_path = 'module_bai_2/training_history.json'
