...
def plot_training_history(history):
    ...
    axes[0, 1].plot(epochs, history['val_recall'], 'orange', label='Recall')
    axes[0, 1].plot(epochs, history['val_f1'], 'purple', label='F1')
    ...
    axes[1, 1].plot(epochs, history['val_f1'], 'purple', alpha=0.7, label='Val F1', linewidth=2)
